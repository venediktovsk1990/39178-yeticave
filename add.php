...
$layout_content='';
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if( isset($_SESSION['user'] ) ){
			...
			$layout_content=includeTemplate('./templates/layout.php', ['main_content'=>$page_content, 'categories'=>$categories, 'is_auth'=>$is_auth, 'user_name'=>$user_name, 'user_avatar'=>$user_avatar, 'title'=>'Добавление нового лота'] );
			print($layout_content);
		}else{
