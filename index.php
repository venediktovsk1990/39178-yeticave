        ...
        <ul class="promo__list">
			<?php for($i=0; $i<count($categories); $i++):  ?>
				<li class="promo__item promo__item--boards">
					<a class="promo__link" href="all-lots.html"> <?php print($categories[$i]); ?></a>
				</li>
			<?php endfor; ?>
        </ul>
    </section>
			...
			<?php for($i=0; $i<count($lots); $i++):  ?>
				<li class="lots__item lot">
					<div class="lot__image">
						<img src=<?=$lots[$i]['img'] ?> width="350" height="260" alt="Сноуборд">
					</div>
					<div class="lot__info">
						<span class="lot__category"><?php print($lots[$i]['category']) ?></span>
						<h3 class="lot__title"><a class="text-link" href="lot.html"> <?php print($lots[$i]['name']) ?> </a></h3>
						<div class="lot__state">
							<div class="lot__rate">
								<span class="lot__amount">Стартовая цена</span>
								<span class="lot__cost"> <?php print($lots[$i]['cost']) ?> <b class="rub">р</b></span>
							</div>
